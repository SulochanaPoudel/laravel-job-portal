...
<head>
	...
	<title>New World Emploment Service</title>
...
<header>
	<nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
		<div class="container">
			<a class="navbar-brand" href="{{ route('home') }}">Job Center</a>
...
<div class="container">
    <p class="text-center text-white pt-3 fw-bold fs-6">© 2024 Job Center, all right reserved</p>
</div>
</footer> 
